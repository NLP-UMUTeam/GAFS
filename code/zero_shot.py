...
from functions import set_seed, standarize_response
...
if __name__ == '__main__':
    ...
    print("Starting zero-shot evaluation with model " + model_name + " on dataset " + args.d)
    ...
    # Obtaining zero-shot prompt
    with open(args.d + "prompts/zs_prompt.txt", "r", encoding="utf-8") as f:
        initial_prompt = f.read()

    # Creating results csv path
    results_path = "results/zs/" + args.d.split("/")[-2] + "/" + model_name
    ...
    for _, row in tqdm(data_test.iterrows(), total=len(data_test)):
        ...
        # Building the prompt with the text
        prompt = initial_prompt.format(text=row['text'])
    ...
    print("End of the zero-shot experimentation with " + model_name + " on dataset " + args.d)